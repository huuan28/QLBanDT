...
UPDATE phieuxuat
SET thoigian = '20240709'
where maphieuxuat >=25;

ALTER TABLE `khachhang`
add column tichluy int;

update  `khachhang`
set ngaythamgia = '20240601';

delete from khachhang
where makh>30;

UPDATE phieunhap
SET thoigian = STR_TO_DATE(CONCAT('2024-', DATE_FORMAT(thoigian, '%m-%d %H:%i:%s')), '%Y-%m-%d %H:%i:%s');
