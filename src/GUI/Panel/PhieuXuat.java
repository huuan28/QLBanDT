...
//        String[] action = {"create","update", "detail", "cancel", "export"};
        ...
        String[] header = new String[]{"STT", "Mã hoá đơn", "Khách hàng", "Nhân viên bán", "Thời gian", "Tổng tiền"};
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == mainFunction.btn.get("create")) {
            ...
            if (getRow() < 0) {
                ...
                ChiTietPhieuDialog ctp = new ChiTietPhieuDialog(m, "Thông tin hóa đơn", true, pxBUS.getSelect(getRow()));
            }
