...
public class TrangChu extends JPanel {
    ...
    JLabel title, subTit, infoDetail[], objDetail[], objDetail1[], infoIcon[];
        String[][] getSt = {
        {"Chính xác", "tinhchinhxac_128px.svg", "<html>Quản lý từng chiếc điện thoại <br> bằng mã IMEI riêng biệt,<br> do đó hệ thống quản lý điện thoại<br> theo mã IMEI sẽ đảm bảo tính <br>chính xác và độ tin cậy cao.</html>"},
    ...
    private void initComponent() {
        ...
        slogan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/slogan1_1.png")));
        top.add(slogan);
