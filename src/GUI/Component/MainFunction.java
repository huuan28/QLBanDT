...
public final class MainFunction extends JToolBar {
    ...
    public void initData() {
        ...
        btn.put("phone", new ButtonToolBar("DS Phiên bản", "phone.svg", "view"));
    }
...
//                btn.get(btnn).setEnabled(false);
                btn.get(btnn).setVisible(false);
            }
        }
        btn.get("import").setVisible(false);
        btn.get("export").setVisible(false);
    }
}
