...
public class Login extends JFrame implements KeyListener {
    ...
    Color colorBtn = new Color(70, 130, 180);
    ...
    private void initComponent() {
        ...
        lbl3 = new JLabel("HỆ THỐNG QUẢN LÝ BÁN ĐIỆN THOẠI ABC");
        ...
        pnlLogIn = new JPanel();
        pnlLogIn.putClientProperty(FlatClientProperties.STYLE, "arc: 10");
        pnlLogIn.setBackground(colorBtn);
    ...
    public void imgIntro() {
        ...
        lblImage = new JLabel();
        lblImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login_1.png")));
