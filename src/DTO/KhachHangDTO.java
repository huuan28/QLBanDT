...
public class KhachHangDTO {
    ...
    public KhachHangDTO(int maKH, String hoten, String sdt, String diachi) {
        ...
        public KhachHangDTO(int maKH, String hoten, String sdt, String diachi,Date ngaythamgia,int tichluy) {
        this.maKH = maKH;
        this.hoten = hoten;
        this.sdt = sdt;
        this.diachi = diachi;
    ...
    public String toString() {
        return "KhachHang{" + "maKH=" + maKH + ", hoten=" + hoten + ", sdt=" + sdt + ", diachi=" + diachi+", tichluy="+tichluy + '}';
    }
